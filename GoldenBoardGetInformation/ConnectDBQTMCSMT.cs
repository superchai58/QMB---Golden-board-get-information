...
{
    public class ConnectDBQTMCSMT
    {
        private bool useDB = true;
        private string connStr = "Data Source=192.168.20.39;Initial Catalog=SMT; Persist Security Info=True; User ID=MunSFUser;Password=is6<2g;";
